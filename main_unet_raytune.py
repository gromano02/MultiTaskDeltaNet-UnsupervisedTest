...
from models.trainer_unet_raytune import *
...
def main(num_samples=10, max_num_epochs=200, gpus_per_trial=1):
    ...
    scheduler = ASHAScheduler(
        ...
        grace_period=2,       #10     ####train each trial at least for n epochs
    ...
    print(f"Best trial final validation f1: {best_trial.metrics['f1']}")
...
if __name__ == "__main__":
    ...
    main(num_samples=4, max_num_epochs=15, gpus_per_trial=1)
