...
def CDTest(path):
    ...
    ##### 103:46, 301:18  (IDs:total of frames)
    ##### 201:27, 203:14
    ##### validation: 103, 301; test: 201,203
    for m in range(46):
            numb = 46
    ...
    ###### seperate results: 
    val_dataset1,val_dataset2,test_dataset1,test_dataset2 = load_dataset_s()      ##### unet data, for each IDs
