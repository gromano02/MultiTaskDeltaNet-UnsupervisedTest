...
def CDEva(model_path,res_path,names):
    ...
    #PATH = '/home/yun13001/code/Carbon/tianyu_new_data/unet_github/checkpoints/test_cv_all_pair2/best_a2.pt'
    ...
    for name in names:
        ...
        for m in range(len(ref)):
            ...
            if numb!=len(ref)-1:
                ...
                img1 = ref[m]    #### save index on the top
                img2 = ref[n]
                ...
                #vis_dir1 = '/home/yun13001/code/Carbon/tianyu_new_data/unet_github/vis/test_cv_all_pair2/a2_save/a1_consecutive'

                try:
                   os.makedirs(res_path+'a1_consecutive')
                except OSError:
                   pass

                try:
                   os.makedirs(res_path+'a1_consecutive/'+name)
                except OSError:
                   pass

                vis_dir1 = res_path + 'a1_consecutive/'+name 
                ...
                #print('f1 test:') 
                #f1 = f1_score(target1.flatten(), pred1.flatten(), average='macro')
                #print('sklearn'+str(f1))
                message = 'a1_'+'_'+ name_+', '
                ...
                #vis_dir2 = '/home/yun13001/code/Carbon/tianyu_new_data/unet_github/vis/test_cv_all_pair2/a2_save/a2_consecutive'

                try:
                   os.makedirs(res_path+'a2_consecutive')
                except OSError:
                   pass

                try:
                   os.makedirs(res_path+'a2_consecutive/'+name)
                except OSError:
                   pass

                vis_dir2 = res_path + 'a2_consecutive/'+name
        ...
        print('size:',a1_f1.shape,a2_f1.shape,name_save.shape)
