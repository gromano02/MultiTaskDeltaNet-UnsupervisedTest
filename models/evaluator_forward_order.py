    ...
    #for name in test_name:
        ...
        for m in range(len(ref)):
            ...
            if numb!=0:
                ...
                vis_dir1 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/vis/test_phy_all_pair_average_f1/a2_save/a1_f_order'
                #file_name1 = os.path.join(vis_dir1, str(n) +'_'+ name)
                ...
                vis_dir2 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/vis/test_phy_all_pair_average_f1/a2_save/a2_f_order'
                #file_name2 = os.path.join(vis_dir2, str(n) +'_'+ name)
        ...
        np.save(vis_dir1+'/'+'a1_'+name_index+'.npy', a1_f1)
        np.save(vis_dir2+'/'+'a2_'+name_index+'.npy', a2_f1)
