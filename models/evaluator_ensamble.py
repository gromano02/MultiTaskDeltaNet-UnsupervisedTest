...
def CDEva():
    ...
    running_metric1 = ConfuseMatrixMeter(n_class=2)     ###### 4 classes
    running_metric2 = ConfuseMatrixMeter(n_class=2)

    PATH = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/checkpoints/test_phy_all_pair_average_f1/best_a2.pt'
    ...
    #for name in test_name: 
        ...
        for m in range(len(ref)):
            ...
            for n in range(len(ref)):
                ...
                #vis_dir1 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv/vis/phy_test_38537/a1_save/a1_each'
                #file_name1 = os.path.join(vis_dir1, str(n) +'_'+ name +'.png')
                ...
                index_name = name1.split("_")[2]
                index = index_name.split('.')[0]
                message = index+'_'+ name+', ' 
                ...
                pred2 = pred1.astype(np.float64)                  
                #vis_dir2 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv/vis/phy_test_38537/a1_save/a2_each'
                #file_name2 = os.path.join(vis_dir2, str(n) +'_'+ name +'.png')
            ...
            pred1[pred1>=0.5]=1.0
            pred1[pred1<0.5]=0.0
            vis_dir1 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/vis/test_phy_all_pair_average_f1/a2_save/a1_ensamble'           
            ##print(name_)
            ...
            pred2[pred2>=0.5]=1.0
            pred2[pred2<0.5]=0.0            
            vis_dir2 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/vis/test_phy_all_pair_average_f1/a2_save/a2_ensamble'
        ...
        np.save(vis_dir1+'/'+'a1_'+name+'.npy', a1_f1)
        np.save(vis_dir2+'/'+'a2_'+name+'.npy', a2_f1)
