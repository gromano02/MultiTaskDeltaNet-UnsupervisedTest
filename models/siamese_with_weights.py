...
class Siamese(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=1, init_features=32):
        ...
        #self.checkpoint = torch.load('/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/checkpoints/unet_same_test/a2_results_15epoch/best_a2.pt', map_location=torch.device(self.device),weights_only=False)   ### unet4
        #self.checkpoint = torch.load('/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/checkpoints/unet_same_test/a1_results_10epoch/best_a1.pt', map_location=torch.device(self.device),weights_only=False)   ### unet3
        #self.checkpoint = torch.load('/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/checkpoints/save_model/unet_test_10epoch/a1_results/best_a1.pt', map_location=torch.device(self.device),weights_only=False)   ### unet3_old
        ##self.checkpoint = torch.load('/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/checkpoints/unet_same_test/a2_results/best_a2.pt', map_location=torch.device(self.device),weights_only=False)   #### unet2 
        self.checkpoint = torch.load('/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/checkpoints/unet_same_test/a1_results/best_a1.pt', map_location=torch.device(self.device),weights_only=False)   #### unet2 
