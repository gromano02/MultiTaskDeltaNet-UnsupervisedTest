...
def CDEva(model_path,res_path,names):
    ...
    for name in names:
        ...
        for m in range(len(ref)):
            ...
            pred1[pred1>=0.5]=1.0
            pred1[pred1<0.5]=0.0
            #vis_dir1 = '/home/yun13001/code/Carbon/tianyu_new_data/unet_github/vis/test_phy_all_pair_average_f1/a2_save/a1_ensamble'
            ...
            pred2[pred2>=0.5]=1.0
            pred2[pred2<0.5]=0.0
            #vis_dir2 = '/home/yun13001/code/Carbon/tianyu_new_data/unet_github/vis/test_phy_all_pair_average_f1/a2_save/a2_ensamble'
