...
def CDTrainer():
    ...
    optimizer_G = optim.AdamW(net_G.parameters(), lr=0.0009551981358212413, betas=(0.9, 0.999), weight_decay=0.01) #### cv best
   ...
   #  training log
    ...
    for epoch_id in range(epoch_to_start, max_num_epochs):
        ...
        checkpoint_dir = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/checkpoints/ablation/'
        name='save_model2/'
    ...
    print('model (mean) saved at',best_epoch_id_m)
