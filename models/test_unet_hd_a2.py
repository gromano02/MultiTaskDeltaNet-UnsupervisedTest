...
def CDTest(path):
    ...
    vis_dir1 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/vis/results6/unet/a2'
    np.savetxt(vis_dir1+'/'+'a2_hd_'+'201'+".txt", hd_img1, fmt="%s", delimiter=",")
    ...
    vis_dir1 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/vis/results6/unet/a2'
    np.savetxt(vis_dir1+'/'+'a2_hd_'+'203'+".txt", hd_img1, fmt="%s", delimiter=",")
    ...
    vis_dir1 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/vis/results6/unet/a2'
    np.savetxt(vis_dir1+'/'+'a2_hd_'+'103'+".txt", hd_img1, fmt="%s", delimiter=",")
    ...
    vis_dir1 = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/vis/results6/unet/a2'
    np.savetxt(vis_dir1+'/'+'a2_hd_'+'301'+".txt", hd_img1, fmt="%s", delimiter=",")
