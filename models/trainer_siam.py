...
def CDTrainer():
    ...
    optimizer_G = optim.AdamW(net_G.parameters(), lr=0.000646846783774518, betas=(0.9, 0.999), weight_decay=0.01) #### cv best
    ...
    #valloader = DataLoader(val_dataset, batch_size=4, shuffle=True, num_workers=8)     ##### cv best    
    ...
    for epoch_id in range(epoch_to_start, max_num_epochs):
        ...
        checkpoint_dir = '/home/yun13001/code/Carbon/tianyu_new_data/unet_github/checkpoints/'
