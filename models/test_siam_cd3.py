...
def CDTest(path):
    ...
    PATH1 = path+'best_m.pt'
    PATH2 = path+'best_m.pt'
    PATH3 = path+'best_m.pt'
    ...
    #print('model save:',epoch_save1,epoch_save2,epoch_save3)
