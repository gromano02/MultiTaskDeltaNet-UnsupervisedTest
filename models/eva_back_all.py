...
def CDEva(model_path,res_path,names):  ### name:val or test
    ...
    #PATH = '/home/yun13001/code/Carbon/tianyu_new_data/unet_github/checkpoints/save_model/test_phy_all_pair_average_f1/best_a2.pt'
    ...
    for name in names:
        ...
        for m in range(len(ref)-1,-1,-1):
            ...
            if numb!=len(ref)-1:
                ...
                #vis_dir1 = '/home/yun13001/code/Carbon/tianyu_new_data/unet_github/vis/test_phy_all_pair_average_f1/a2_save/a1_b_order'
                ...
                #vis_dir2 = '/home/yun13001/code/Carbon/tianyu_new_data/unet_github/vis/test_phy_all_pair_average_f1/a2_save/a2_b_order'
                
                try:
                   os.makedirs(res_path+'a2_b_order')
                except OSError:
                   pass

                try:
                   os.makedirs(res_path+'a2_b_order/'+name)
                except OSError:
                   pass

                vis_dir2 = res_path + 'a2_b_order/'+name
