...
#os.environ["CUDA_VISIBLE_DEVICES"] = "2"      ##### if train model on particulart GPU
...
def CDTrainer():
    ...
    trainloader = DataLoader(train_dataset, batch_size=4, shuffle=True, num_workers=8,worker_init_fn=seed_worker,generator=gen)
    valloader = DataLoader(val_dataset, batch_size=4, shuffle=True, num_workers=8)
    ...
    for epoch_id in range(epoch_to_start, max_num_epochs):
        ...
        checkpoint_dir = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/cv_github/checkpoints/unet_same_test/'
        name='a2_results_15epoch/'
