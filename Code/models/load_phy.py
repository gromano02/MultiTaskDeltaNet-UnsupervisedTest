...
def load_dataset():
    ...
    val_dataset = REGDataset(val_ref,val_res,val_label1,val_label2,val_ref_y,val_res_y,val_Max,val_Min,val_L,val_pi,img_size=256,is_train=False,to_tensor=True)
