...
from models.test_siam_cd import *                      ##### It is for model evaluation right after training. 
                                                       ##### For no_init, choose models.sia_two_out_four_class at test_siam_cd.py; 
                                                       ##### For init1 or init2 choose models.siamese_with_weights at test_siam_cd.py 
...
##### change thecorresponding line for no_init, init1 or init2.
...
def CDTrainer():
    ...
    for epoch_id in range(epoch_to_start, max_num_epochs):
        ...
        checkpoint_dir = '/home/yun13001/code/Carbon/model_reg/tianyu_new_data/code_github/cv_github/checkpoints/'      ###### save model
